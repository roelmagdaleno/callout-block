/**
 * This file is from "Icon Block" Gutenberg plugin.
 * It allows us to render the SVG string to a React component.
 *
 * @since 1.0.0
 *
 * @author Nick Diego
 ...
 * @link https://github.com/ndiego/icon-block/blob/main/src/utils/parse-icon.js
 */
